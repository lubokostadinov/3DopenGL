...
public:
	...
	//FOR OBJ 
	PlanetMesh(const PlanetMesh& obj)
	{
	...
	void render(Shader* shader)
	{
		...
		//Render
		if (this->nrOfIndices == 0)
			glDrawArraysInstanced(GL_TRIANGLES, 0, this->nrOfVertices, 8000);
		else
			glDrawElementsInstanced(GL_TRIANGLES, this->nrOfIndices, GL_UNSIGNED_INT, 0, 8000);
